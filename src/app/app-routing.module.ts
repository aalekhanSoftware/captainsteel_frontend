...
import { OrderTakenByListComponent } from './components/order-taken-by/order-taken-by-list/order-taken-by-list.component';
import { OrderTakenByFormComponent } from './components/order-taken-by/order-taken-by-form/order-taken-by-form.component';
...
const routes: Routes = [
  ...
  {
    path: 'order-taken-by',
    component: OrderTakenByListComponent,
    canActivate: [AuthGuard, RoleGuard],
    data: { roles: ['ADMIN'] }
  },
  {
    path: 'order-taken-by/create',
    component: OrderTakenByFormComponent,
    canActivate: [AuthGuard, RoleGuard],
    data: { roles: ['ADMIN'] }
  },
  {
    path: 'order-taken-by/edit/:id',
    component: OrderTakenByFormComponent,
    canActivate: [AuthGuard, RoleGuard],
    data: { roles: ['ADMIN'] }
  },
